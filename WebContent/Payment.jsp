                ...
                <tr>
                    ...
                    <td valign="top" class="main-nav">
                        ...
                        <a id="a_Products" href="default1.jsp">Products</a>
						  ...
						  <td valign="top" class="main-nav">
                   <a id="a_Contact" href="ContactUs1.jsp">Contact Us</a>
                        
             
                    
                    <td valign="top" class="main-nav">
                        <a id="a_Contact" href="default.jsp">Log Out</a></td>
                </tr>
            </table>
        </td>
    </tr>
                                                                            ...
                                                                            <td valign="top" class="pad-t10">
                                                                                <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <span class="form_row">
                                                                                                  <label>Rs. 17650/- only</label>
                                                                                            </span>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    <td>
                                                                                       <input type="radio" name="sex" value="CHeque">CHEQUE/DD<br>
																						<input type="radio" name="sex" value="COD">COD
                                                                                    </td>
                                                                                    </tr>
                                                                                   
                                                                                        <td height="28" align="right" valign="top">
                                                                                            <strong>ADDRESS TO POST</strong></td>
                                                                                        <td align="center" valign="top">
                                                                                            <strong>:</strong></td>
                                                                                        <td>
                                                                                            <span class="form_row">
                                                                                                <textarea name="textarea" class="contact_textarea" id="tb_Message" >
                                                                                                L 1046 Vit Mens Hostel
                                                                                                Vit University
                                                                                                Vellore - 632014
                                                                                                </textarea>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center">
                                                                                            &nbsp;</td>
                                                                                        <td height="35">
                                                                                            <a href="default.jsp" ><input type="button" id="submit" value="Submit"></a>    
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
