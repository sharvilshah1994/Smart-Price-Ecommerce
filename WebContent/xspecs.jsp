            ...
            <a href="note4.jsp">Note 4</a></td>
                                        ...
                                        <td width="540" valign="top">
                                            <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td align="center">
                                                   <strong>MOTO X SPECS</strong><br>
												<img src="images/motoxcap.JPG" width="450" height="600" alt="" title=""
                                            border="0" style="border: 1px #DBDBDB solid; padding: 4px;" />
                                	<img src="images/motoxcap1.JPG" width="450" height="600" alt="" title=""
                                            border="0" style="border: 1px #DBDBDB solid; padding: 4px;" />
